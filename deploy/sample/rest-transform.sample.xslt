...
-->
<!-- %roxy:params("uri=xs:string", "priority=xs:int") -->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:trns="http://marklogic.com/rest-api/transform/sample" xmlns:map="http://marklogic.com/xdmp/map">
